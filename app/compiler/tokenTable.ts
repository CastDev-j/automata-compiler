export const tokenTable: Record<number, { token: number; word: string } | { token: number; word: string }[]> = {
  ...
  20004: [ { token: 8000, word: "ID" }, { token: 3030, word: "+" }],
  20005: [ { token: 8000, word: "ID" }, { token: 3030, word: "-" }],
  20006: [ { token: 8000, word: "ID" }, { token: 3030, word: "*" }],
  20007: [ { token: 8000, word: "ID" }, { token: 3030, word: "/" }],
  20008: [ { token: 8000, word: "ID" }, { token: 2010, word: "++" }],
  20009: [ { token: 8000, word: "ID" }, { token: 2020, word: "--" }],
  200010: [ { token: 8000, word: "ID" }, { token: 2050, word: "%" }],
